...
const Pricing = () => (
  <Layout
    ...
    description="Explore Botify's affordable AI chatbot pricing plans – Pro and Unlimited. Scale customer support with smart automation and priority access."
  >
    <div className="min-h-screen bg-gradient-to-br from-purple-100 via-indigo-200 to-blue-100 flex items-center justify-center p-6 sm:p-8">
      <div className="bg-white p-6 sm:p-10 rounded-2xl shadow-2xl max-w-4xl w-full space-y-8">
