...
const Contact = () => (
  <Layout
    ...
    description="Get in touch with Botify for support, business inquiries, or feedback. Contact us via email, phone, or visit our office. We're ready to assist!"
  >
    <div className="min-h-screen bg-gradient-to-br from-purple-100 via-indigo-200 to-blue-100 flex items-center justify-center p-6 sm:p-8">
      <div className="bg-white p-6 sm:p-10 rounded-2xl shadow-2xl max-w-3xl w-full space-y-6">
        <h1 className="text-4xl font-extrabold text-purple-700 text-center drop-shadow-md">📞 Contact Us</h1>

        <div className="space-y-4 text-lg text-gray-800 leading-relaxed">
          <p>
            <span className="font-semibold text-purple-600">📧 Email:</span>{" "}
            <a href="mailto:botify.assist@gmail.com" className="text-indigo-600 hover:underline">
              botify.assist@gmail.com
            </a>
          </p>
          <p>
            <span className="font-semibold text-purple-600">📞 Phone:</span>{" "}
            <a href="tel:+919263400564" className="text-indigo-600 hover:underline">
              +91-9263400564
            </a>
          </p>
          <p>
